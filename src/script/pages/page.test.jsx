  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed top-4 left-4 z-50 p-2 bg-white shadow-lg rounded-xl transition-all duration-300 hover:shadow-xl hover:scale-105 ${
